 ...
 *             @OA\Property(property="timezone", type="string", example="Europe/Warsaw", description="IANA timezone used when aggregating workouts and notifications")
     ...
     *                 @OA\Property(property="avatar_url", type="string", nullable=true, description="Set null to remove avatar"),
     ...
     *     summary="Fetch user avatar image",
     *     tags={"Profile"},
     *     @OA\Parameter(
     *         name="user",
     *         in="path",
 ...
 *     @OA\Property(property="avatar_url", type="string", nullable=true, description="Public API URL for avatar image"),
