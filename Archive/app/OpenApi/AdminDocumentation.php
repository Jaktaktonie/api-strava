 ...
 *     @OA\Property(property="users_new_period", type="integer", nullable=true),
 *     @OA\Property(property="activities_total", type="integer"),
 *     @OA\Property(property="distance_total_km", type="number", format="float"),
 *     @OA\Property(property="duration_total_seconds", type="integer"),
 *     @OA\Property(property="avg_speed_total_kmh", type="number", format="float", nullable=true),
 ...
 *     @OA\Property(property="period_duration_seconds", type="integer", nullable=true),
 *     @OA\Property(property="period_avg_speed_kmh", type="number", format="float", nullable=true),
 *     @OA\Property(property="likes_total", type="integer"),
 *     @OA\Property(property="likes_period", type="integer", nullable=true),
 *     @OA\Property(property="comments_total", type="integer"),
 *     @OA\Property(property="comments_period", type="integer", nullable=true),
 *     @OA\Property(property="reports_total", type="integer"),
 *     @OA\Property(property="reports_period", type="integer", nullable=true),
 *     @OA\Property(property="blocks_total", type="integer"),
 *     @OA\Property(property="blocks_period", type="integer", nullable=true),
 *     @OA\Property(property="friend_requests_total", type="integer"),
 *     @OA\Property(property="friend_requests_period", type="integer", nullable=true)
 * )
 */
