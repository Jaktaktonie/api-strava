...
class ActivityDocumentation
{
     ...
     *                 ),
     *                 @OA\Property(property="notes", type="string", nullable=true, example="Evening tempo workout"),
     *                 @OA\Property(property="photo_url", type="string", nullable=true, description="Set null to remove photo"),
     *                 @OA\Property(property="photo", type="string", format="binary"),
     *                 @OA\Property(property="gpx_path", type="string", nullable=true, example="activities/1234.gpx")
     *             )
     *         )
    ...
    /**
     * @OA\Get(
     *     path="/api/activities/{id}/photo",
     *     summary="Fetch activity photo image",
     *     tags={"Activities"},
     *     security={{"sanctum":{}}},
     *     @OA\Parameter(
     *         name="id",
     ...
     *     @OA\Response(
     *         response=200,
     *         description="Activity photo image"
     *     ),
     *     @OA\Response(response=403, description="Forbidden"),
     *     @OA\Response(
     *         response=404,
 ...
 *     @OA\Property(property="photo_url", type="string", nullable=true, description="Public API URL for activity photo"),
